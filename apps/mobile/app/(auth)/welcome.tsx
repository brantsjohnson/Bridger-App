...
// a short story -> Next after each screen, or five seconds -> glitch -> screen
// shuts off). When it finishes we remember that this install has seen it, and
// we send them to the sign-in screen. It only ever plays once per install.
//
