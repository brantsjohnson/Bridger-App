...
// For now it's a friendly placeholder: tapping News shows "Local updates
// coming soon." It still gets a real page title, the header profile
    ...
    <Screen tone="canvas">
      ...
      <ScreenBody>
        ...
        <AnalyticsRegion
          ...
          accessibilityLabel="Local updates coming soon"
        >
